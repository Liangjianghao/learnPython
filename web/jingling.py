...
driver.get_screenshot_as_file('/Users/l/Desktop/img/image.jpg')#比较好理解
im =Image.open('/Users/l/Desktop/img/image.jpg')
# box = (800,730,870,780)  #设置要裁剪的区域
box = (750,260,820,300)  #设置要裁剪的区域
region = im.crop(box)     #此时，region是一个新的图像对象。
region.show()#显示的话就会被占用，所以要注释掉
region.save("/Users/l/Desktop/img/image_code.jpg")
im=Image.open("/Users/l/Desktop/img/image_code.jpg")
imgry = im.convert('L')#图像加强，二值化
sharpness =ImageEnhance.Contrast(imgry)#对比度增强
sharp_img = sharpness.enhance(2.0)
sharp_img.save("/Users/l/Desktop/img/image_code.jpg")
...
print(pytesseract.image_to_string(Image.open('/Users/l/Desktop/img/image_code.jpg')))
