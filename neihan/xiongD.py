...
#   PRIMARY KEY (`Id`)
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='内涵胸表';
import datetime
import time 
import requests
import json
...
def insertChatContent(create_time,content_type,content,url):
	...
	# 插入数据  
	sql = "INSERT INTO xiongTable (create_time,content_type,content,url) VALUES ( '%s', '%s', '%s','%s')"  
	print sql
