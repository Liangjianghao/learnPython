...
def insertChatContent(create_time,digg_count,content,url,category_name,comments,maxtime):
	...
	# 插入数据  
	sql = "INSERT INTO neihanGoodATable (create_time,digg_count,content,url,category_name,comments,time_param) VALUES ( '%s', '%s', '%s','%s','%s','%s','%s')"  
