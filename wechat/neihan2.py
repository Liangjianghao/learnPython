...
def insertChatContent(create_time,content_type,content,url):
	...
	# 插入数据  
	sql = "INSERT INTO video (create_time,content_type,content,url) VALUES ( '%s', '%s', '%s','%s')"  
	print sql
							...
							# share_url 漫画
								if joker['group']['digg_count']>10000:
									if joker['group']['text']:
										...
										content='略'
									insertChatContent(joker['group']['create_time'],joker['group']['digg_count'],content,joker['group']['mp4_url'])
